...
class SumServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.DoSum = channel.unary_unary(
                '/sum.SumService/DoSum',
                request_serializer=sum__pb2.SumRequest.SerializeToString,
                response_deserializer=sum__pb2.SumReply.FromString,
...
def add_SumServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'DoSum': grpc.unary_unary_rpc_method_handler(
                    servicer.DoSum,
                    request_deserializer=sum__pb2.SumRequest.FromString,
                    response_serializer=sum__pb2.SumReply.SerializeToString,
            ),
    }
